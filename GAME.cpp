...
void GAME::playGame()
{
	...
	this->LIMIT = field.sum;
		...
		for (int i = 0; i < 5; i++) {
			...
			std::cout << "        ##########################################" << std::endl;
			if(BOTS[i]->getTime()< 10){
				std::cout << "        ##   TIME:        " << BOTS[i]->getTime()<< "                     ##" << std::endl;
			}
			else {

				if (BOTS[i]->getTime() < 100) {
					std::cout << "        ##   TIME:        " << BOTS[i]->getTime() << "                    ##" << std::endl;
				}
				else {
					if (BOTS[i]->getTime() < 1000) {
						std::cout << "        ##   TIME:        " << BOTS[i]->getTime() << "                   ##" << std::endl;
					}
					else {
						if (BOTS[i]->getTime() < 10000) {
							std::cout << "        ##   TIME:        " << BOTS[i]->getTime() << "                  ##" << std::endl;
						}
					}
...
void GAME::GAME_MENU() {
	...
	std::cout << "        ##    2 ................. TEST - FIELD   ##" << std::endl;
	std::cout << "        ##    3 ................. TEST - BOT     ##" << std::endl;
	std::cout << "        ##    4 ................. TEST - GAME    ##" << std::endl;
	std::cout << "        ##    5 ................. TEST - ALL     ##" << std::endl;
	std::cout << "        ##                                       ##" << std::endl;
	std::cout << "        ###########################################" << std::endl;
	std::cout << "        ###########################################" << std::endl << std::endl;
	std::cout << std::endl << std::endl;
